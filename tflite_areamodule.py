...
test_path = "CNN_Classifier/DB/japanese_NPR_area_class/val"
...
def test_models(test_path,tf_path,tflite_model_quant,tflite_path):
    ...
    dataset_labels =  ["shizuoka","fukuoka","fukushima","gifu","gunma","hiroshima","kanazawa","kitami","kochi","nilgata","obihiro","oita","tokushima","toyama","utsunomia","okayama","sappora","sendai","numazu","chiba","yamanashi","tama","osaka",
      "yokohama","maebashi","nerima","wakayama","kobe","miyazaki","saitama","kumagaya","shinagawa","nara","adachi","kyoto","naniwa","himeji","kawasaki"]
...
if __name__ == '__main__':
    ...
    tf_path = "CNN_Classifier/weights/japanese_NPR_area_class/MobileNet.h5"
        
    tflite_path= "CNN_Classifier/weights/japanese_NPR_area_class/converted_model_float32.tflite"

    tflite_quantized_path= "CNN_Classifier/weights/japanese_NPR_area_class/converted_model_int8quantized.tflite"
    ...
    if 1: #Convert tf to tflite with quantized
        ...
        check_quantised_model(tflite_model_quant)
        if 1:#Testing
